========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Skydance
========================================================================


Diese Skydance-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Skydance-Anwendung bilden.
...
res\Skydance.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Skydance.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in Skydance.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

SkydanceDoc.h, SkydanceDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CSkydanceDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CSkydanceDoc::Serialize).

SkydanceView.h, SkydanceView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CSkydanceView.
    	CSkydanceView-Objekte werden verwendet, um CSkydanceDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Skydance.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
