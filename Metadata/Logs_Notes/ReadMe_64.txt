========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : SkyServer
========================================================================


Diese SkyServer-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre SkyServer-Anwendung bilden.
...
SkyServer.h
	...
	Anwendungsklasse CSkyServerApp.
...
res\SkyServer.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei SkyServer.rc eingebunden.
...
SkyServerDlg.h, SkyServerDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CSkyServerDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in SkyServer.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	SkyServer.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
