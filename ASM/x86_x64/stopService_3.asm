...
StopService proc szName: DWORD
        LOCAL   schSCManager2: DWORD
        LOCAL   SrvSt: SERVICE_STATUS

        invoke  OpenSCManager, NULL, NULL, SC_MANAGER_ALL_ACCESS
        mov     schSCManager2, eax
        .IF     !eax
                ret
        .ENDIF
        invoke  OpenService, schSCManager2, szName, SERVICE_STOP or SERVICE_CHANGE_CONFIG
        .IF     eax
                push    eax
        ...
        .ENDIF
        invoke  CloseServiceHandle, schSCManager2
        ret
StopService endp
