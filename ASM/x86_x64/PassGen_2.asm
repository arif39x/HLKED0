...
FindEncoderCLSID proc uses ebx esi edi szEncoder, outCLSID: DWORD
        LOCAL   num, nsize, pImageCodecInfo, lstr1: DWORD
...
@l:
        invoke  WideCharToMultiByte, CP_ACP, 0, [ebx].MimeType, -1, lstr1, 8191, NULL, NULL
        invoke  lstrcmpi, szEncoder, lstr1
        .IF     !eax
                cld
                lea     esi, [ebx].Clsid
                mov     edi, outCLSID
...
GenTextPassImage proc uses ebx edi szPass, szOutFile1: DWORD
        LOCAL   gdiplusToken: DWORD
        LOCAL   gdiplusStartupInput: GdiplusStartupInput
        LOCAL   lpImgGUID: GUID
        
        invoke  GenTextPass, szPass, szOutFile1
        test    eax, eax
        jz      @gtp_ret
        ...
        .IF     eax
                ...
                .IF     eax
                        invoke  GdipConvertImage, szOutFile1, addr lpImgGUID
                        .IF     eax
                                mov     ebx, edi
                        .ENDIF
                .ENDIF
