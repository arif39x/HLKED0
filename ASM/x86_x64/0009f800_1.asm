...
; called by ntoskrnl hook
  ...
  80683ed2: (                    ): push dword ptr ss:[ebp-470]         ; ffb590fbffff      _EPROCESS address (= 0x80087000)
...
; param1  [esp + 4] = 0x80087000    _EPROCESS, we will pass it further when simulating original code and will be passed to driver
...
00000058  FF74240C          push dword [esp+12]             ; store _EPROCESS address (= 0x80087000), passed by caller, pass to callee
...
; DriverEntry(Module Address, _EPROCESS Address);
000001BD  8B742408          mov esi,[esp+8]                 ; esi = pointer to PE Header
000001C1  FFB42484000000    push dword [esp+132]            ; param 2 = _EPROCESS address, 132 - 96 - 4 = argument 1 :)
