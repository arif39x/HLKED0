...
0000002E  BA8000            mov dx,0x80								; boot drive
...
00000059  BA8000            mov dx,0x80								; boot drive
...
Exit_Int13_hook_ret:
00000128  CA0200            retf 0x2													; simulate "iretw" instruction, to preserve flags (especially flags.CF)
