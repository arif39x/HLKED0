...
#pragma comment(lib,"WSOCK32")
 ...
 int SocketOpen(int Port,char *Address,int iMyMessage);
 //int SocketOpen  (int Port,char *Address, HWND hWnd,int iMyMessage,BOOL IRC);
 SOCKET SocketListen(int nPort,unsigned int iMyMessage);
 int SocketSend(SOCKET The_Socket,const char* buf,int count);
