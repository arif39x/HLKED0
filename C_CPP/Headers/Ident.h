...
*/
#ifndef __INC_IDENT_H_
#define __INC_IDENT_H_

//#include <globals.h>

#define MAX_IDENT_SOCKETS 5

class IdentSock : public TcpSock
{
public:
	IdentSock();
	~IdentSock();
	void DataIn(SOCKET iCheckSocket);
	void Accept(SOCKET iAcceptSocket);
};

#endif //__INC_IDENT_H_