...
// not encoded strings
static char string_dlerror[] = "0x4dci:ERR";
static char string_downloaded[] = "Complete";
static char string_nostart[] = "Unable to Exec";
static char string_running[] = "Running:";
static char string_removing[] = "Running, uninst...";
static char string_unknown[] = "000000:ERR.";
...
DWORD WINAPI DL_Thread(LPVOID param)
{
	...
	_snprintf(buffer, sizeof(buffer) - 1, "XDLI: %s to: %s", dl.url, dl.destination);
